...
var template = '<div class="container" id ="toolbar">' + 'Tid: <span id="timer">10:00</div>' + '</div>' + '<div class="container">' + '<textarea id="textInput" height="300px"></textarea>' + '<div id="placeholder"></div>' + '</div>';
