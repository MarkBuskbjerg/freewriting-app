...
var template = '<div class="tekstr-cta-box" id ="toolbar">' + 'Tid: <span id="timer">10:00</div>' + '</div>' + '<div class="tekstr-info-box">' + '<textarea id="textInput" rows="14" placeholder="Du starter programmet, når du skriver her.."></textarea>' + '<div id="placeholder"></div>' + '</div>';
